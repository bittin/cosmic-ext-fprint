...
delete-all-fallback = Questo servizio di impronte digitali non supporta l'eliminazione di una singola impronta. Eliminare invece tutte le impronte digitali di questo utente?
