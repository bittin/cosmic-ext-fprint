...
delete-all-fallback = Tämä sormenjälkipalvelu ei tue yksittäisen sormenjäljen poistamista. Poistetaanko kaikki tämän käyttäjän sormenjäljet?
...
help-validity = Jonkin laitteiston kanssa, kuten esimerkiksi Validity skannereiden kanssa, sinun tulee tällä hetkellä käyttää open-fprintd:tä.
settings-device =
    { $nbr ->
        [1] Sinulla on { $nbr } tuettu laite
