...
delete-all-fallback = Tato služba otisků prstů nepodporuje mazání jednoho otisku. Smazat místo toho všechny otisky tohoto uživatele?
...
verify-swipe-too-short = Přejetí bylo příliš krátké. Zkuste to znovu.
verify-finger-not-centered = Prst nebyl uprostřed. Zkuste to znovu.
verify-remove-and-retry = Sejměte prst a zkuste to znovu.
...
page-right-ring-finger = Pravý prsteníček
page-right-little-finger = Pravý malíček
page-left-thumb = Levý palec
page-left-index-finger = Levý ukazováček
page-left-middle-finger = Levý prostředníček
...
enroll-swipe-too-short = Přejetí bylo příliš krátké. Přejíždějte prosím po celé délce snímače.
enroll-finger-not-centered = Prst není uprostřed. Umístěte jej prosím doprostřed snímače.
enroll-remove-and-retry = Sejměte prst a zkuste to znovu.
enroll-unknown-error = Došlo k neznámé chybě.
enroll-completed = Otisk byl zaregistrován.
enroll-failed = Registrace selhala.
enroll-disconnected = Zařízení bylo odpojeno.
enroll-data-full = Úložiště otisků je plné. Smažte prosím některé otisky.
...
error-no-enrolled-prints = Pro tento prst nejsou zaregistrovány žádné otisky.
error-claim-device = Nepodařilo se převzít zařízení.
